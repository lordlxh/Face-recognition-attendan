	...
	<body>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
					<tr>
						<th class="tablestyle_title">发布与删除考勤</th>
					</tr>
					<tr>
						<td class="CPanel">
								...
								<TR>
									<TD width="100%">
										<fieldset style="height:100%;">
											<legend>考勤操作选择</legend>
											<table border="0" cellpadding="2" cellspacing="1" style="width:100%">

		<td><a href="servlet/AttendanceServlet?method=Insert" >新建考勤表</a>&nbsp;|&nbsp;
        <a href="servlet/AttendanceServlet?method=RemoveAll">清空当前考勤表</a></td> ${msg }											
