...
<html>
  <head>
	...
	<body>
		<form name="fom" id="fom" method="post" action="servlet/ARoleServlet?method=Change">
		<input type="text" name="Rid" value="${role.rid }"/>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
					<tr>
						<th class="tablestyle_title">角色信息更新</th>
					</tr>
					<tr>
						<td class="CPanel">
										...
										<fieldset style="height:100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
												...
												<tr>
													<td>角色名称:</td>
													<td>
														<input name="Rname" type="text" class="text" style="width:154px" value="${role.rname }" />${msg }
													</td>
												</tr>
