...
<html>
  <head>
	...
	<body>
		<form name="fom" id="fom" method="post" action="servlet/AUserServlet?method=Change">
										...
										<fieldset style="height:100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
												...
												<tr>
													<td>照片文件:</td>
													<td>
														<input name="photoname" type="text" class="text" style="width:154px" value="${user.photoname }" /> 
												</tr>
											</table>
											<br />
										</fieldset>
