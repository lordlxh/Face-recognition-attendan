...
<html>
  <head>
	...
	<body>
		<form name="fom" id="fom" method="post" action="servlet/AttendanceServlet?method=Change">
										...
										<fieldset style="height:100%;">
											...
											<table border="0" cellpadding="2" cellspacing="1" style="width:100%">
												...
												<tr>
													<td>考勤情况:</td>
													<td>
														<input name="attendance" type="text" class="text" style="width:154px" value="${attendance.attendance }" /> 
												</tr>
												<tr>
													<td>考勤时间:</td>
													<td>
														<input name="aDate" type="text" class="text" style="width:154px" value="${attendance.aDate }" /> 
												</tr>
											</table>
											<br />
										</fieldset>
